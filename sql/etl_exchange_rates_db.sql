...
SELECT * FROM STG_FOREIGN_EXCHANGE_RATES_TRENDS WHERE CURRENCY = 'EUR';
...
FROM(
    ...
    WHERE DATE IS NOT NULL) AS unique_dates
ORDER BY DATE;
...
SELECT * FROM DIM_CURRENCY LIMIT 20;
SELECT * FROM DIM_COUNTRY LIMIT 20;
SELECT * FROM DIM_STATUS LIMIT 20;
SELECT * FROM FACT_FOREX LIMIT 20;
